...
AjaxAction.prototype._ajaxCall = function() {
  ...
  jQuery.when.apply(null, promises).always(function() {
    console.log("TUTTE LE OPERAZIONI SONO STATE COMPLETATE:")
...
// Default onSuccessAction to overwrite for DOI REQUEST and CATEGORY
...
function populateOntologyRows(data) {
  console.log('populateOntologyRows(data): data= ', data); //cancellami
...
jQuery(".admin.index").ready(function() {
  ...
  // ONTOLOGIES ADMIN - BUTTON onclick actions ---------------------------------------
