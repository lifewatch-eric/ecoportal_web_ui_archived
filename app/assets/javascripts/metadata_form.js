  ...
  <div class="row creatorType">
    ...
    <div class="col-sm-offset-1 col-sm-3">                  
      <button type="button" onclick="removeCreator('creator-$1')" class="btn btn-danger btn-sm"  access="false" id="button-remove-creator-$1">
        Remove This Creator <span class="glyphicon glyphicon-trash"></span></button>
    </div>
  </div>
    ...
    <div class="row row-creatorIdentifier-buttons">
      <div class="col-sm-11">
        <button type="button" class="col-md-4 btn-default btn btn-xs" access="false" id="button-add-creatorIdentifier" onclick="addCreatorIdentifier($1)">
          <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Creator Identifier</button>
      </div>
    </div>
  </div>                  
    ...
    <div class="row row-creatorAffiliation-buttons">
      <div class="col-sm-11">
        <button type="button" class="col-md-4 btn-default btn btn-xs" id="button-add-creatorAffiliation" onclick="addCreatorAffiliation($1)">
          <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Affiliation</button>
      </div>
    </div>
  </div>
</div>`
...
function addCreatorIdentifier(creatorIndex, creatorIdentifierObj) {
  ...
  html = `
    ...
    <div class="col-sm-1">
      <button type="button" onclick="removeCreatorIdentifier('creatorIdentifier-${creatorIndex}_$1')" class="btn btn-default btn-sm btn-remove-row"  access="false" id="button-remove-creatorIdentifier-${creatorIndex}_$1">
  ...
  let div = $('<div/>', { class:"row row-creatorIdentifier", id:"creatorIdentifier-" + creatorIndex + "_" + index });
  div.append(html);
...
function addCreatorAffiliation(creatorIndex, creatorAffiliationObj) {
  ...
  <div class="col-sm-1">
    <button type="button" onclick="removeCreatorAffiliation('creatorAffiliation-${creatorIndex}_$1')" class="btn btn-default btn-sm btn-remove-row"  access="false" id="button-remove-creatorAffiliation-${creatorIndex}_$1">
      <span class="glyphicon glyphicon-trash"></span></button>
  </div>`;
  ...
  let div = $('<div/>', { class:"row row-creatorAffiliation", id:"creatorAffiliation-" + creatorIndex + "_" + index });
  div.append(html);
...
function addTitle(titleObj) {
  ...
  html = `
    ...
    <div class="col-sm-1 div-btn-remove">                  
      <button type="button" onclick="removeTitle('title-$1')" class="btn btn-default btn-sm btn-remove-title"  access="false" id="button-remove-title-$1">
      <span class="glyphicon glyphicon-trash"></span></button>
    </div>`
