 ...
 # When getting "Add submission" form to display
   def new
    ...
    if @submission
      ...
      #LOGGER.debug("  WEB_UI - SubmissionsController#new - identifierRequestList=#{@identifierRequestList.inspect}")
      @identifierRequest = identifierRequestList.select {|r| r.status == "PENDING"}.first
      #LOGGER.debug("  WEB_UI - SubmissionsController#new - @identifierRequest=#{@identifierRequest.inspect}")
    end
    @submission ||= LinkedData::Client::Models::OntologySubmission.new
    #LOGGER.debug("  WEB_UI - SubmissionsController#new : \n\n  @ontology = #{@ontology.inspect} \n\n @submission = #{@submission.inspect} \n\n")
  ...
  def create
    ...
    if !@submission_saved || @submission_saved.errors
      ...
      # LOGGER.debug("submissions_controller:create - #{ @errors[:error]}")
